...
We've delved into some exploitation techniques such as [buffer overflow](https://vickieli.dev/binary%20exploitation/buffer-overflow/), [buffer overread](https://vickieli.dev/binary%20exploitation/buffer-overread/), and [format string attacks](https://vickieli.dev/binary%20exploitation/format-string-vulnerabilities/). These memory corruption bugs can lead to attackers injecting and executing their own code.
...
![](https://vickieli.dev/assets/images/binary-16.png)
...
![](https://vickieli.dev/assets/images/binary-17.png)
...
![](https://vickieli.dev/assets/images/binary-18.png)
...
![](https://vickieli.dev/assets/images/binary-19.png)
...
![](https://vickieli.dev/assets/images/binary-20.png)
...
![](https://vickieli.dev/assets/images/binary-21.png)
